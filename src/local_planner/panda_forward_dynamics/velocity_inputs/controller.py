...
class Controller:
    def __init__(self, robot, step_time=1/240):
        ...
        self.goal_position = np.array([0.65, 0.8, 1.24])
        self.goal_orientation = np.array([1, 0, 0, 0])
    ...
    def step(self, time):
        ...
        vel_constraints_lower_h = -np.ones((7, 1))*2.1750/100
        vel_constraints_higher_h = np.ones((7, 1))*2.1750/100
